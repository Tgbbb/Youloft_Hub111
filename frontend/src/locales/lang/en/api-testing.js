...
export default {
  ...
  automation: {
    ...
    url: 'URL',
    extractVariables: 'Extract',
    moveUp: 'Move Up',
    moveDown: 'Move Down',
    addParam: 'Add Param',
    paramTip: 'Params override same-named params in the interface definition. Supports {{var}} and ${func()} syntax.',
    addHeader: 'Add Header',
    editCase: 'Edit Case',
    inputCaseName: 'Enter case name',
    params: 'Query Params',
    headers: 'Headers',
    bodyInherit: 'Inherit Interface',
    bodyNone: 'No Body',
    bodyJson: 'JSON',
    bodyRaw: 'Raw Text',
    bodyOther: 'Keep Original ({type})',
    bodyJsonPlaceholder: 'Enter JSON, e.g. {"name": "{{name}}"}',
    bodyRawPlaceholder: 'Enter raw request body',
    bodyEmptyTip: 'Choose JSON or Raw Text to override the interface request body',
    paramsFromInterface: 'The interface parameters are pre-filled for editing. After save, this list becomes the case parameters (overrides the interface defaults).',
    headersFromInterface: 'The interface headers are pre-filled for editing. After save, this list becomes the case headers (overrides the interface defaults).',
    interfaceBodyPreview: 'Interface default body (preview only):',
    extractRules: 'Response Variable Extract Rules',
    extractTip: 'After this case runs, variables are extracted from the response and can be referenced by later cases with {{varName}}. Priority: environment defaults < interface < case override < extracted variables.',
    extractNamePlaceholder: 'Variable name',
    extractSourceBody: 'Response Body',
    extractSourceHeader: 'Response Header',
    extractSourceStatus: 'Status Code',
    extractJsonPathPlaceholder: 'JSONPath, e.g. $.data.token',
    extractHeaderNamePlaceholder: 'Header name, e.g. Content-Type',
    addExtractRule: 'Add Extract Rule',
    variablesBefore: 'Variables Before',
  ...
  aiServiceConfig: {
    ...
    apiKeyHint: 'Current key: {preview}. Leave blank to keep the existing key.',
  ...
  messages: {
    success: {
      ...
      suiteCreated: 'Test suite created',
      suiteUpdated: 'Test suite updated'
    },
    error: {
      ...
      loadRequestTree: 'Failed to load requests',
    ...
    warning: {
      ...
      extractNameRequired: 'Variable name is required',
      extractJsonPathRequired: 'JSONPath expression is required',
      extractHeaderNameRequired: 'Header name is required',
