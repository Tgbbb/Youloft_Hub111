export default {
  requirementAnalysis: {
    ...
    extractDocument: '提取需求文档',
    extracting: 'AI正在提取整理需求文档...',
    extractedContent: 'AI整理后的需求文档（可编辑）',
    extractedContentPlaceholder: 'AI提取的需求文档将展示在此处，您可以编辑修改...',
    extractSuccess: '需求文档提取成功',
    extractFailed: '需求文档提取失败',
    ...
    functionModule: '功能模块（可选）',
    noModule: '不关联模块',
    functionModuleFilter: '功能模块',
    ...
    // Clarification
    clarifying: '🔍 AI正在分析需求，识别不明确点...',
    clarificationTitle: '🤔 需求澄清确认',
    clarificationSubtitle: 'AI发现以下需求中不明确的地方，请确认或补充后再生成用例（可跳过直接生成）：',
    clarificationQuestionLabel: '问题 {id}',
    clarificationAnswerPlaceholder: '请输入您的确认或补充信息...',
    clarificationSkip: '跳过，直接生成',
    clarificationConfirm: '确认并生成用例',
    clarificationNoQuestions: 'AI未发现明显不明确点，可直接生成用例',
    clarificationFailed: '需求澄清分析失败',
    clarificationError: '澄清分析出错，是否跳过直接生成？',
  ...
  promptConfig: {
    ...
    clarifierPrompt: '需求澄清提示词',
    clarifierTab: '需求澄清',
    defaultClarifierName: '默认需求澄清提示词',
    reviserPrompt: '用例改进提示词',
    reviserTab: '用例改进',
    defaultReviserName: '默认用例改进提示词',
    extractorPrompt: '需求文档提取提示词',
    extractorTab: '文档提取',
    smokePrompt: '冒烟流程生成提示词',
    smokeTab: '冒烟用例',
    defaultExtractorName: '默认需求文档提取提示词',
    isActive: '是否启用',
    promptContent: '提示词内容',
