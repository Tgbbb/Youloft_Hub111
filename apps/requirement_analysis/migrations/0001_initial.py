    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_type', models.CharField(choices=[('deepseek', 'DeepSeek'), ('qwen', '通义千问'), ('siliconflow', '硅基流动'), ('zhipu', '智谱'), ('xiaomi', '小米'), ('xiaomi_coding_plan', '小米coding plan'), ('other', '其他')], max_length=20, verbose_name='模型类型')),
