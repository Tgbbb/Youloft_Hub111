...
router.register(r'midscene/sequences', MidsceneSequenceViewSet, basename='midscene-sequences')
...
urlpatterns = [
    ...
    path('midscene/config/', MidsceneConfigView.as_view(), name='midscene-config'),
]
